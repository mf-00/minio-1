...
lint:
	@echo "Running $@:"
	@GO15VENDOREXPERIMENT=1 ${GOPATH}/bin/golint github.com/mf-00/minio/cmd...
	@GO15VENDOREXPERIMENT=1 ${GOPATH}/bin/golint github.com/mf-00/minio/pkg...
...
test: build
	...
	@GO15VENDOREXPERIMENT=1 go test $(GOFLAGS) github.com/mf-00/minio/cmd...
	@GO15VENDOREXPERIMENT=1 go test $(GOFLAGS) github.com/mf-00/minio/pkg...
